...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
    ...
    <div class=invest-form-area" id="invest-abbr">
        ...
        <input type="text" name="abbr" placeholder=""> <br>
    </div>
